...
<body>
    ...
    <main>
        <p>Cadastre-se no formulário abaixo</p>
        ...
        <form action="" method="post">
            ...
            <input type="text" name="nome" id="nome" required value="<?= $_SERVER["REQUEST_METHOD"] == "POST" ? $nome : "" ?>">
            <br> <br>

            <!-- email -->
            <label for="email">E-mail:</label>
            <input type="email" name="email" id="email" required value="<?= $_SERVER["REQUEST_METHOD"] == "POST" ? $email : "" ?>">
            <br> <br>

            <!-- idade -->
            <label for="idade">Idade:</label>
            <input type="number" name="idade" id="idade" min="18" max="100" required value="<?= $_SERVER["REQUEST_METHOD"] == "POST" ? $idade : "" ?>">
            <br> <br>

            <!-- senha -->
            <label for="senha">Senha:</label>
            <input type="password" name="senha" id="senha" required value="<?= $_SERVER["REQUEST_METHOD"] == "POST" ? $senha : "" ?>">
            <br> <br>
